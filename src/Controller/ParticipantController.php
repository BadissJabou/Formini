...
class ParticipantController extends AbstractController
{
    ...
    public function afficherList(Request $request)
    {
        ...
        $participants = $repo->findAll(); // Utiliser findAll pour récupérer tous les participants

        if ($form->isSubmitted() && $form->isValid()) {
            $data = $form->getData();
            $participants = $repo->recherche($data['critere']); // Utiliser la méthode "recherche" appropriée pour rechercher les participants
        }

        return $this->render('participant/liste.html.twig', [ // Utiliser le template "liste.html.twig" approprié pour les participants
            'participants' => $participants, // Utiliser le nom de variable approprié pour les participants
